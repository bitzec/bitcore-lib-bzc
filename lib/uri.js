 ...
 * ```javascript
 *
 * var uri = new URI('bitzec:12A1MyfXbW6RhdRAZEqofac5jCQQjwEPBu?amount=1.2');
 ...
 * ```javascript
 *
 * var valid = URI.isValid('bitzec:12A1MyfXbW6RhdRAZEqofac5jCQQjwEPBu');
 * // true
 * ```
 *
 * @param {string|Object} data - A bitcoin URI string or an Object
