...
describe('BufferReader', function() {
  ...
  describe('#readUInt64LEBN', function() {
    ...
    it('should return 10BZC', function() {
      var tenbzc = 10 * 1e8;
      var tenbzcBuffer = new Buffer('00ca9a3b00000000', 'hex');
      var br = new BufferReader(tenbzcBuffer);
      br.readUInt64LEBN().toNumber().should.equal(tenbzc);
    });
